  ...
  <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
    <div className="w-full max-w-6xl bg-white rounded-3xl overflow-hidden shadow-2xl grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-12 text-white flex-col justify-center">
        ...
        <p className="text-lg text-blue-100 leading-8">
          Find trusted professionals, book services instantly,
          track providers live and manage everything in one place.
        </p>
        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Full Name"
              className="w-full border rounded-xl pl-12 p-3 outline-none focus:border-blue-500"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Password"
              className="w-full border rounded-xl pl-12 pr-12 p-3 outline-none focus:border-blue-500"
            />
          ...
          {role === "PROVIDER" && (
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              ...
              <p className="text-sm text-gray-600 mt-2">
                After signup you'll complete your provider
                profile, upload documents and start
                accepting bookings.
              </p>
            </div>
          )}
